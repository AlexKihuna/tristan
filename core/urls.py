...
urlpatterns = [
    ...
    url(r'^customers/id/(?P<pk>[0-9]+)/update$', views.CustomerUpdateView.as_view(), name='customer_edit'),
    url(r'^customers/id/(?P<pk>[0-9]+)/delete$', views.CustomerDeleteView.as_view(), name='customer_delete'),
    ...
    url(r'^suppliers/id/(?P<pk>[0-9]+)/update$', views.SupplierUpdateView.as_view(), name='supplier_edit'),
    url(r'^suppliers/id/(?P<pk>[0-9]+)/delete$', views.SupplierDeleteView.as_view(), name='supplier_delete'),
